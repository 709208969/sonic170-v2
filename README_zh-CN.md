...
| 文件 | 说明 |
|---|---|
| `sonic170v2灯光编辑工具.html` | 网页编辑器（单文件、零依赖、WebHID/WebUSB、可离线使用） |
...
1. 用 **Chrome 或 Edge** 打开 `sonic170v2灯光编辑工具.html`（双击文件即可，完全离线可用）。
2. 点击**连接**，选择键盘。
3. 编辑灯效、图案或动画——所有修改即时生效。
